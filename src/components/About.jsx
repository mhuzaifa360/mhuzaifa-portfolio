        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
              ...
              <div className="relative bg-gradient-to-br from-[#0f1222] to-[#0a0c12] rounded-3xl p-6 border border-[#262b44] shadow-2xl">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  ...
                  <div className="bg-[#1a1f36]/50 p-3 rounded-xl text-center border border-[#2a3150] hover:border-[#3b4eff]/50 transition-all">
                    ...
                    <p className="text-white text-sm font-semibold truncate">huzaifa@example.com</p>
                  </div>
                  <div className="bg-[#1a1f36]/50 p-3 rounded-xl text-center border border-[#2a3150] hover:border-[#3b4eff]/50 transition-all">
                    <span className="text-2xl block mb-1">💼</span>
                    <p className="text-[#b9c3e6] text-xs">Available</p>
                    <p className="text-green-400 text-sm font-semibold">Freelance</p>
                  </div>
                </div>
          ...
          <div className={`flex-1 transition-all duration-1000 delay-500 transform ${
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
              I'm <span className="bg-gradient-to-r from-[#8b9dff] to-[#5f7cff] bg-clip-text text-transparent">Huzaifa</span>, MERN Stack Developer
            </h3>
            ...
            <p className="text-[#b9c3e6] leading-relaxed mb-6">
              With over 2 years of experience in web development, I've worked 
              on diverse projects ranging from e-commerce platforms to complex 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-[#1a1f36] flex items-center justify-center border border-[#3b4eff]/30">
                  <svg className="w-5 h-5 text-[#5f7cff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <div>
                  <p className="text-white font-semibold">Experience</p>
                  <p className="text-[#b9c3e6] text-sm">2+ Years Professional</p>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-[#1a1f36]/30 to-transparent p-5 rounded-2xl border-l-4 border-[#5f7cff]">
              <p className="text-[#cdd9ff] italic text-sm md:text-base">
                "Code is poetry written in logic. I strive to create elegant solutions 
                that are both functional and beautiful."
              </p>
              <p className="text-[#5f7cff] text-sm mt-2 font-semibold">— Huzaifa</p>
            </div>
          </div>
        </div>
      </div>
