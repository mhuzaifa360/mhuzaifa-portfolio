  ...
  const projects = [
    {
      ...
      features: ["User auth", "Product management", "Stripe integration", "Order tracking"],
      icon: "🛒",
    ...
    },
    {
      ...
      features: ["Drag & drop", "Real-time sync", "Team workspaces", "File attachments"],
      icon: "✅",
    ...
    },
    {
      ...
      description: "Modern, animated portfolio website with dark theme and responsive design.",
      features: ["Smooth animations", "Fully responsive", "Dark/Light mode", "Contact form"],
      icon: "🎨",
    ...
    },
    {
      ...
      description: "RESTful API for blog platform with authentication and CRUD operations.",
    ...
    },
    {
      ...
      features: ["Real-time messaging", "Typing indicators", "Online status", "Media sharing"],
      icon: "💬",
  ...
  return (
    <section className="bg-[#0a0c12] py-20 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filter Buttons */}
        <div className={`flex justify-center gap-3 mb-12 flex-wrap transition-all duration-1000 delay-200 ${
          isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        }`}>
          <button 
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech, i) => (
                      <span key={i} className="px-2 py-1 bg-[#1a1f36] rounded-md text-[#7e8eff] text-xs">
                        {tech}
                      </span>
                    ))}
                  </div>
                  ...
                  {/* Features List */}
                  <div className="mb-4">
                    <p className="text-[#cdd9ff] text-xs font-semibold mb-2">Key Features:</p>
                    <div className="flex flex-wrap gap-1">
                      {project.features.slice(0, 2).map((feature, i) => (
                        <span key={i} className="text-[#b9c3e6] text-xs">• {feature}</span>
                      ))}
                      {project.features.length > 2 && (
                        <span className="text-[#5f7cff] text-xs">+{project.features.length - 2} more</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 pt-3 border-t border-[#1e243e]">
                    <a href="#" className="text-[#5f7cff] text-sm hover:text-white transition-colors flex items-center gap-1">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                      </svg>
                      Live Demo
                    </a>
                    <a href="#" className="text-[#cdd9ff] text-sm hover:text-white transition-colors flex items-center gap-1">
